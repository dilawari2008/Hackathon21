...
class VehicleTableWarehouse extends Component {    
    ...
    render() {
        ...
        const columns = [
          ...
          const data = this.props.vehicleData.filter( vehicle => {
            return (vehicle.status!='warehouse' ? false : true);
          } );
...
export default connect(mapStateToProps,mapDispatchToProps)(VehicleTableWarehouse);