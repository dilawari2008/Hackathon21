...
class VehicleTableInbound extends Component {    
    ...
    render() {
        ...
        const columns = [
          ...
          const data = this.props.vehicleData.filter( vehicle => {
            return (vehicle.status!='inbound' ? false : true);
          } );
...
export default connect(mapStateToProps,mapDispatchToProps)(VehicleTableInbound);